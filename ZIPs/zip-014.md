...
cd /path/to/lux/node
go get github.com/luxfi/node/crypto/bls    # BLS signatures
go get github.com/luxfi/node/crypto/secp256k1  # ECDSA
...
- Zoo validators use `github.com/luxfi/node/crypto/bls` directly (not a separate KMS client)
