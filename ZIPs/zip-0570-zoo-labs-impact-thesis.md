---
zip: 570
title: Zoo Labs Impact Thesis
tags: [impact, vision, ecosystem, thesis, conservation]
...
follow-on: [zoo-fund-impact-thesis, zoo-foundation-mission]
created: 2025-12-17
requires: [500]
---
...
| Entity | Treasury Contracts | Explorer |
|--------|-------------------|----------|
| **Zoo Foundation** | SAFE contracts on Lux C-Chain | [explorer.lux.network](https://explorer.lux.network) |
| **Zoo Sub-DAOs** | Individual SAFE contracts | [explorer.lux.network](https://explorer.lux.network) |
...
|----------|-----|---------|
| **Zoo Vote** | [zoo.vote](https://zoo.vote) | Conservation proposals, sub-DAO funding, mission alignment |
...
1. **View Proposals**: Browse active conservation and governance proposals at [zoo.vote](https://zoo.vote)
...
| Platform | URL | Focus |
|----------|-----|-------|
| **Zoo Vote** | [zoo.vote](https://zoo.vote) | Conservation, nonprofit, life-first initiatives |
| **Lux Vote** | [lux.vote](https://lux.vote) | Blockchain infrastructure, DeFi governance |
| **Hanzo Vote** | [hanzo.vote](https://hanzo.vote) | AI infrastructure, deep tech acceleration |
...
|------------|-----|-------|
| **LuxDAO Contracts** | [github.com/luxfi/dao](https://github.com/luxfi/dao) | Solidity governance contracts |
| **Zoo ZIPs** | [github.com/zoolabs/zips](https://github.com/zoolabs/zips) | Zoo Improvement Proposals |
| **Lux Standard Contracts** | [github.com/luxfi/standard](https://github.com/luxfi/standard) | Shared contract standards |
